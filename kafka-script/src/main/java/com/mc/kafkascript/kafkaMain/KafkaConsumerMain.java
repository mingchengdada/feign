...
/**
 * 项目名称:   pinkstone
 * 包:        com.mc.kafkascript.kafkaMain
 * 类名称:     KafkaConsumerMain
 * 类描述:     类功能描述
 * 创建人:     mc
 * 创建时间:   2019/9/25 9:32
 */
public class KafkaConsumerMain {
    ...
    public static void main(String[] args) {
        ...
        KafkaConsumerMain consumer = new KafkaConsumerMain();
    ...
    public void consumerAssin(String isAutoCommitBool,String topic){
        ...
        consumer.subscribe(Arrays.asList("mc_test"));
        while (true) {
            ConsumerRecords<String, String> records = consumer.poll(5000);
            for (ConsumerRecord<String, String> record : records){
